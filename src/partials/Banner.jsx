          ...
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-slate-500 inline-flex">
              <a
                ...
                href="https://devlucaslinks.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                Grupo<span className="hidden sm:inline"> no Discord</span>
              </a>{' '}
              <span className="italic px-1.5">ou</span>{' '}
              <a className="font-medium hover:underline text-emerald-400" href="https://lucasdeveloper.netlify.app/" target="_blank" rel="noreferrer">
                Developer
              </a>
            </div>

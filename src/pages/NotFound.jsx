      ...
      */}
      <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-blue-500 sm:text-5xl">Page not found</h1>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <Link to='https://lucasdeveloper.netlify.app/' className="text-sm font-semibold text-white hover:text-blue-200">

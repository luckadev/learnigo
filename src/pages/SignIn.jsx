          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1">Bem vindo de volta. Nós vamos alavancar o aprendizado.</h1>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <div className="flex justify-between">
                        <Link to="/reset-password" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Esqueceu a senha?</Link>
                      </div>
                    </div>
                  </div>
                ...
                <div className="text-gray-400 text-center mt-6">
                  Não tem uma conta? <Link to="/signup" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Cadastrar</Link>
                </div>
              </div>
